    ...
    <div className="h-full overflow-scroll relative backdrop-blur-lg">
      ...
      <div className="flex items-center gap-3 py-3 mx-4 border-b border-stone-500">
        ...
        <img
          ...
          alt=""
        />
        <img src={assets.help_icon} className="max-hd:hidden max-w-5" alt="" />
      </div>
      {/* Chart part */}
      <div className="flex flex-col pb-16  p-3 h-[calc(100%-64px)] overflow-y-scroll ">
        {messages?.map((msg, index) => (
          <div
            key={index}
            className={`flex items-end gap-2 justify-end ${
              (msg.receiverID === authUser._id) && "flex-row-reverse"
            }`}
          >
            {msg.image ? (
              <img
